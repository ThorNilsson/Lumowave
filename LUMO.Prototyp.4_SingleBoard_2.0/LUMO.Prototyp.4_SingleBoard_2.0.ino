...
const int SkipBut1 = 2;
const int RighBut2 = 5;
const int LeftBut3 = 3;      
...
void loop() {
  ...
  if (StateSkipBut1 == LOW) { Serial.println("Next mode pressed"); Mode++; if(Mode == 7){Mode = 1;} FadeBlackMode(); Serial.println(Mode); delay(250);  }
  
  if (StateLeftBut3 == LOW && Mode == 1 && Fina > 1)    { Serial.println("LeftBut3 Fina-");  FadeBlack();  Fina--;  Serial.println(Fina); delay(100);}
  if (StateRighBut2 == LOW && Mode == 1 && Fina < 15)   { Serial.println("RighBut2 Fina+");  FadeBlack();  Fina++;  Serial.println(Fina); delay(100);}
  
  if (StateLeftBut3 == LOW && Mode == 2 && Worm > 1)    { Serial.println("LeftBut3 Worm-");  FadeBlack();  Worm--;  Serial.println(Worm); delay(100);}
  if (StateRighBut2 == LOW && Mode == 2 && Worm < 14)   { Serial.println("RighBut2 Worm+");  FadeBlack();  Worm++;  Serial.println(Worm); delay(100);}
    
  if (StateLeftBut3 == LOW && Mode == 3 && Party > 0) { Serial.println("LeftBut3 Party-"); FadeBlack();  Party--; Serial.println(Party); delay(100);}
  if (StateRighBut2 == LOW && Mode == 3 && Party < 7) { Serial.println("RighBut2 Party+"); FadeBlack();  Party++; Serial.println(Party); delay(100);}

  if (StateLeftBut3 == LOW && Mode == 4) { Serial.println("Nyans 1+: ");  Nyans1 = Nyans1 + 5; if (Nyans1 > 255){ Nyans1 = 0;} Serial.println(Nyans1);}
  if (StateRighBut2 == LOW && Mode == 4) { Serial.println("Nyans 2+: ");  Nyans2 = Nyans2 + 5; if (Nyans2 > 255){ Nyans2 = 0;} Serial.println(Nyans2);}

  if (StateLeftBut3 == LOW && Mode == 5 && Brightness > 0){ Serial.println("Brightness -: "); Brightness = Brightness - 5; Serial.println(Brightness);}
  if (StateRighBut2 == LOW && Mode == 5 && Brightness < 130)  { Serial.println("Brightness +: "); Brightness = Brightness + 5; Serial.println(Brightness);}

  if (StateLeftBut3 == LOW && Mode == 6 && Speed < 50) { Serial.println("Långsammare: ");   Speed = Speed - 10; Serial.println(Speed); delay(100);}
  if (StateRighBut2 == LOW && Mode == 6 && Speed > 10) { Serial.println("Snabbare: ");      Speed = Speed + 10; Serial.println(Speed); delay(100);}
  
  if (StateSaveBut4 == LOW) { Serial.println("SaveBut4 pressed"); FadeBlack(); Mode--; Serial.println(Mode);  delay(500);}
